            ...
            <div className="staff">
                ...
                <div className="personas">
                    <div className="persona">
                        <img src="imagenes/descarga.jpg" alt="Persona1" />
                        <h5>Pedro Garcia</h5>
                        <h6>gerente</h6>
                    ...
                    <div className="persona">
                        <img src="imagenes/descarga.jpg" alt="Persona2" />
                        <h5>nombre2</h5>
                        <h6>subgerente</h6>
                        <p>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Nulla eos consectetur nostrum labore
                            ducimus necessitatibus ratione culpa! Minima ab nulla voluptatem. Inventore amet fugiat magni
                    ...
                    <div className="persona">
                        <img src="imagenes/descarga.jpg" alt="Persona3" />
                        <h5>nombre3</h5>
                        <h6>gerente</h6>
                        <p>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Nulla eos consectetur nostrum labore
                            ducimus necessitatibus ratione culpa! Minima ab nulla voluptatem. Inventore amet fugiat magni
                    ...
                    {/* <div className="persona">
                    <img src="imagenes/descarga.jpg" alt="Persona4"/>
                    <h5>nombre4</h5>
                    <h6>gerente</h6>
                    <p>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Nulla eos consectetur nostrum labore
                        ducimus necessitatibus ratione culpa! Minima ab nulla voluptatem. Inventore amet fugiat magni
                ...
                <div className="persona">
                    <img src="imagenes/descarga.jpg" alt="Persona5"/>
                    <h5>nombre5</h5>
                    <h6>gerente</h6>
                    <p>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Nulla eos consectetur nostrum labore
                        ducimus necessitatibus ratione culpa! Minima ab nulla voluptatem. Inventore amet fugiat magni
